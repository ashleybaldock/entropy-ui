...
// Icon from https://www.svgrepo.com/svg/15575/low-temperature-thermometer

const rssiToLevel = (rssi) => {
  if (rssi < -89) {
    return 0;
  }
  if (rssi < -78) {
...
export const WiFiIcon = ({
  ...
  return (
    <svg
      ...
      {...props}
    >
      <g transform="translate(0.000000,1100.000000) scale(0.100000,-0.110000)">
        <path
          className={bars > 2 ? activeClassname : ''}
        ...
        />
        <path
          className={bars > 1 ? activeClassname : ''}
        ...
        />
        <path
          className={bars > 0 ? activeClassname : ''}
